// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AMessage.cs" company="John Oxley && Etienne Yamsi">
//    2019
// </copyright>
// <summary>
...
namespace ISO_8583_Specification
{
    ...
    /// </remarks>
    public abstract class AMessage : IMessage, ICloneable
    {
        ...
        /// </returns>
        public virtual string ToMsgString()
        {
            return ToMsg().ToHex();
        }
