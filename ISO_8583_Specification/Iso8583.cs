// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Iso8583.cs" company="John Oxley && Etienne Yamsi">
//    2019
// </copyright>
// <summary>
...
namespace ISO_8583_Specification
{
    ...
    public class Iso8583 : AMessage
    {
        ...
        /// <summary>
        /// Gets the message as a string ready to send over the network
        /// </summary>
        /// <returns>
        /// string representing the message 
        /// </returns>
        public override string ToMsgString()
        {
            return ToMsg().ToHex();
        }
            ...
            var template = new Template
                {
                    ...
                    { Bit._003_PROC_CODE, FieldDescriptor.AsciiFixed(6, FieldValidators.An) },
                    ...
                    { Bit._006_CARDHOLDER_AMOUNT, FieldDescriptor.AsciiFixed(12, FieldValidators.N) },
                    ...
                    { Bit._024_NETWORK_INTERNATIONAL_IDENTIFIER, FieldDescriptor.AsciiFixed(3, FieldValidators.N) },
                    ...
                    { Bit._048_ADDITIONAL_DATA_PRIVATE, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._047_ADDITIONAL_DATA_NATIONAL, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    ...
                    { Bit._056_RESERVED_ISO, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._057_RESERVED_NATIONAL, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._058_RESERVED_NATIONAL, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    ...
                    { Bit._105_RESERVED_ISO_USE, FieldDescriptor.AsciiVar(3,999,FieldValidators.Ansp) },
                    ...
                    { Bit._122_PROVIDER_NAME, FieldDescriptor.AsciiVar(2, 99, FieldValidators.Ans) },
                    { Bit._123_COLLECTOR_BALANCE, FieldDescriptor.AsciiVar(3, 120, FieldValidators.An) },
                };
        ...
        public class Bit
        {
            ...
            ///   CardHolder Amount
            /// </summary>
            public const int _006_CARDHOLDER_AMOUNT = 6;
            ...
            /// </summary>
            public const int _024_NETWORK_INTERNATIONAL_IDENTIFIER = 24;
            ...
            /// <summary>
            ///   Field 47 - Additional Data
            /// </summary>
            public const int _047_ADDITIONAL_DATA_NATIONAL = 47;

            /// <summary>
            ///   Field 48 - Additional Data
            /// </summary>
            public const int _048_ADDITIONAL_DATA_PRIVATE = 48;
            ...
            /// <summary>
            ///   Field 56 - RESERVED_ISO
            /// </summary>
            public const int _056_RESERVED_ISO = 56;

            /// <summary>
            ///   RESERVED_NATIONAL
            /// </summary>
            public const int _057_RESERVED_NATIONAL = 57;

            /// <summary>
            ///   RESERVED_NATIONAL
            /// </summary>
            public const int _058_RESERVED_NATIONAL = 58;
            ...
            /// </summary>
            public const int _105_RESERVED_ISO_USE = 105;
            ...
            /// </summary>
            public const int _122_PROVIDER_NAME = 122;

            /// <summary>
            ///   Provider Name, Number
            /// </summary>
            public const int _123_COLLECTOR_BALANCE = 123;
